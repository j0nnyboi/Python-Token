...
from ledamint.transactions import deploy, topup, mint, send, burn, update_token_metadata
...
class LedamintAPI():
    ...
    def topup(self, api_endpoint, to, amount=20, max_retries=3, skip_confirmation=False, max_timeout=60, target=20, finalized=True):
        """
